import { Brain, FileOutput, FileText, MoveRight } from "lucide-react";
...
const steps: Step[] = [
  {
    ...
    description: "Simple drag and drop your pdf document or click upload",
  },
  {
  ...
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        <div className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl bg-linear-to-br from-rose-500/50 to-transparent group-hover:from-rose-500/20 transition-colors">
